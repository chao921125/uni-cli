<template>
    <scroll-view v-if="timeArr.length" class="time-select-box" :scroll-x="true" :scroll-left="0">
                ...
                <view class="re-flex time-block-box">
                    ...
                    >
                        <view
                            ...
                            class="select-block"
                            :class="{ 'select-block-active': timeSelect[index] === item }"
                        ></view>
                        <view
                            v-else
                            class="select-block"
                            :class="{ 'select-block-activeed': timeSelect[index] === item }"
                        ></view>
                    </view>
                </view>
            </view>
        ...
        <view class="re-flex-row-center-start">
            <view class="re-flex">
                <view v-for="(item, index) in timeTextArr" :key="index" class="time-text re-text-center">
                    {{ item }}
                </view>
            </view>
        </view>
