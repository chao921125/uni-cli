<template>
    <uni-popup ref="dialog" :type="props.type" background-color="#fff">
        <view class="dialog-container">
            <view class="content-text">{{ props.content }}</view>
            <view class="btn-box">
                <button class="btn btn-left" @tap="onCancel">Cancel</button>
                <button class="btn btn-right" @tap="onConfirm">Confirm</button>
            </view>
        </view>
    </uni-popup>
</template>
