<template>
    <uni-popup ref="popup" background-color="#fff">
        <view class="popup-content" :class="{ 'popup-height': props.type === 'left' || props.type === 'right' }">
            <view class="re-flex-row-between re-pt-20 re-pb-40">
                <text class="re-pl-20 btn-text" @tap="cancel">Cancel</text>
                <text>{{ result[0] }} - {{ result[1] }}</text>
                <text class="re-pr-20 btn-text" @tap="confirm">Confirm</text>
            </view>
            <picker-view
