<template>
    <picker-view v-if="props.visible" :indicator-style="dateObj.indicatorStyle" :value="dateObj.value" @change="changeClick" class="picker-view">
        <picker-view-column>
            <view class="item" v-for="(item, index) in dateObj.years" :key="index">{{ item }}Year</view>
        </picker-view-column>
        <picker-view-column>
            <view class="item" v-for="(item, index) in dateObj.months" :key="index">{{ item }}Month</view>
        </picker-view-column>
        <picker-view-column>
            <view class="item" v-for="(item, index) in dateObj.days" :key="index">{{ item }}Day</view>
        </picker-view-column>
    </picker-view>
</template>
