...
export default {
	 ...
	 * @param params {*} 请求参数
	 * @param isForm boolean 数据格式 true: "application/x-www-form-urlencoded" false:"application/json"
	 * @param hideLoading boolean 是否隐藏loading true: 隐藏 false:显示
	 */
	...
	/**
	 * 上传文件
	 * @param url {Object} 请求地址
	 * @param [files, filePath] {Object} 要上传的文件,Array[File]/String，理论上不推荐使用path
	 * @param name {Object}
	 * @param fileType {Object} 文件类型
	 * @param formData {Object}
	 * @param hideLoading boolean 是否隐藏loading
	 */
